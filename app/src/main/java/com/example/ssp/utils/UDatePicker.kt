...
class UDatePicker {
    companion object {
        ...
        @RequiresApi(Build.VERSION_CODES.O)
        fun createDatePickerDialog(textViewClick: TextView, textViewSet: TextView, activity: FragmentActivity, viewModel: HomeActivityViewModel, isStartDate: Boolean) {
            textViewClick.setOnClickListener {
                ...
                val datePickerDialog = DatePickerDialog(
                    ...
                    { _, year, monthOfYear, dayOfMonth ->
                        ...
                        textViewSet.text = dateFormatter
                        if(isStartDate) {
        ...
        @RequiresApi(Build.VERSION_CODES.O)
        fun createDatePickerDialog(textViewClick: TextView, textViewSet: TextView, activity: FragmentActivity) {
            textViewClick.setOnClickListener {
